...
linear model does well for num_cc_nonnhh
...
plot(D_df$republican_percentage_won, D_df$num_cc_nonhh, 
     ...
     main = "Linear Regression of Non-HH Contacts on Republican Percentage Won")
...
```
What about masked contacts?
```{r}
D_model_Mcontacts <- lm(republican_percentage_won ~ Norm_Masks_Used, data = D_df)

plot(D_df$republican_percentage_won, D_df$Norm_Masks_Used, 
     xlab = "Republican Percentage Won", ylab = "Proportion Where Masks Used",
     main = "Linear Regression of Mask Usage on Republican Percentage Won")

abline(D_model_contacts, col = "blue")

R_model_Mcontacts <- lm(democrat_percentage_won ~ Norm_Masks_Used, data = R_df)

plot(R_df$democrat_percentage_won, R_df$Norm_Masks_Used, 
     xlab = "Democrat Percentage Won", ylab = "Proportion Where Masks Used",
     main = "Linear Regression of Mask Usage on Democrat Percentage Won")

abline(R_model_contacts, col = "blue")

print(summary(D_model_Mcontacts))
print(summary(R_model_Mcontacts))
```
```{r}
# Fit the Model
