...
```{r}
D_model_contacts <- lm(num_cc_nonhh ~ trump_percentage_won + COV_County_CMR_2020_06_20 + State_Government_Response_Index_11192020 + COUNTY_RUCC_2013 + resp_sex + resp_educ + resp_yob + r_working + r_race, data = D_df)
...
R_model_contacts <- lm(num_cc_nonhh ~ biden_percentage_won + COV_County_CMR_2020_06_20 + State_Government_Response_Index_11192020 + COUNTY_RUCC_2013 + resp_sex + resp_educ + resp_yob + r_working + r_race, data = R_df)
