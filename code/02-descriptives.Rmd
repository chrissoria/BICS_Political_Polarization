...
average_by_party <- filtered_df %>%
  ...
  summarise(
    ...
    num_houshold = weighted.mean(num_cc_nonhh, w = weight_pooled, na.rm = TRUE),
...
bi_nonhh <- lm(num_cc_nonhh ~ prev_week_inc_rate, data = bics_zip_features, weights = weight_pooled)
bi_mask <- lm(Norm_Masks_Used ~ prev_week_inc_rate, data = bics_zip_features, weights = weight_pooled)
