...
pred_race <- ggplot(combined_contrasts, aes(x = contrast, y = -1 * estimate, fill = contrast)) +
  ...
  labs(x = "Contrast", y = "Estimated Difference in Contacts", title = "Difference in Predicted Contacts Between Groups") +
  scale_x_discrete(labels = c("Young", "Republican", "White", "Male")) +
...
ggsave("contrast_contacts.png", plot = pred_race, path = "/Users/chrissoria/Documents/Research/BICS_Political_Polarization/plots", width = 12, height = 8, units = "in")
...
pred_race <- ggplot(combined_contrasts, aes(x = contrast, y = -1 * estimate, fill = contrast)) +
  ...
  geom_errorbar(aes(ymin = -1 * (estimate + SE), ymax = -1 * (estimate - SE)), 
                position = position_dodge(0.7), width = 0.25) +  # Add error bars
  labs(x = "Contrast", y = "Estimated Difference in Contacts", title = "Difference in Predicted Mask Usage Between Groups") +
  scale_x_discrete(labels = c("Young", "Republican", "White", "Male")) +
  scale_fill_manual(values = c("young0 - young1" = "gray", "republican0 - republican1" = "red", 
                               "white0 - white1" = "gray", "male0 - male1" = "gray")) +
  theme_minimal() +
...
ggsave("contrast_masks.png", plot = pred_race, path = "/Users/chrissoria/Documents/Research/BICS_Political_Polarization/plots", width = 12, height = 8, units = "in")
