...
```{r}
cd_masked_model <- lm(Norm_Masks_Used ~  `rate_prev_11/20/20` + State_Government_Response_Index_11192020 + COUNTY_RUCC_2013 + resp_sex + resp_educ + resp_yob + r_working + r_race + political_party_to_CD+ cityNY +`cityBay Area` +cityPhiladelphia + cityPhoenix +cityBoston + cityAtlanta, 
                           data = bics_zip_features,
                           weights = weight_pooled)
